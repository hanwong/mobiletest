import { p as jo, n as _t, s as ce, T as N, o as ot, R as Wo, a as C, t as W, b as K, y as gt } from "./index-jdRbyd6Y.js";
/**
 * @license
...
const Ho = (e) => new no(typeof e == "string" ? e : e + "", void 0, vr), I = (e, ...t) => {
 ...
 */
var Ce;
const he = window, kr = he.trustedTypes, Fo = kr ? kr.emptyScript : "", Ir = he.reactiveElementPolyfillSupport, sr = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Fo : null;
      break;
 ...
 */
var Ae;
const ue = window, Ot = ue.trustedTypes, Tr = Ot ? Ot.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, lr = "$lit$", rt = `lit$${(Math.random() + "").slice(9)}$`, so = "?" + rt, Zo = `<${so}>`, ft = document, Zt = () => ft.createComment(""), Vt = (e) => e === null || typeof e != "object" && typeof e != "function", ao = Array.isArray, Vo = (e) => ao(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", _e = `[ 	
...
const Ko = (e, t) => {
  ...
  for (let a = 0; a < r; a++) {
    ...
    i += s === Rt ? l + Zo : b >= 0 ? (n.push(c), l.slice(0, b) + lr + l.slice(b) + rt + f) : l + rt + (b === -2 ? (n.push(void 0), a) : f);
  }
...
class Kt {
  constructor({ strings: t, _$litType$: r }, n) {
    ...
    this.parts = [];
    let i = 0, s = 0;
    const a = t.length - 1, l = this.parts, [c, d] = Ko(t, r);
          ...
          for (const h of o.getAttributeNames())
            if (h.endsWith(lr) || h.startsWith(rt)) {
              ...
              if (b.push(h), f !== void 0) {
                ...
                l.push({ type: 1, index: i, name: g[2], strings: p, ctor: g[1] === "." ? Yo : g[1] === "?" ? Go : g[1] === "@" ? Qo : ve });
              } else
...
class qo {
  ...
  u(t) {
    ...
    for (; c !== void 0; ) {
      if (a === c.index) {
        let d;
        c.type === 2 ? d = new Jt(s, s.nextSibling, this, t) : c.type === 1 ? d = new c.ctor(s, c.name, c.strings, this, t) : c.type === 6 && (d = new Xo(s, this, t)), this._$AV.push(d), c = o[++l];
      }
...
class Jt {
  ...
  _$AI(t, r = this) {
    t = kt(this, t, r), Vt(t) ? t === B || t == null || t === "" ? (this._$AH !== B && this._$AR(), this._$AH = B) : t !== this._$AH && t !== pt && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : Vo(t) ? this.T(t) : this._(t);
  }
  k(t) {
  ...
  g(t) {
    ...
    if (((r = this._$AH) === null || r === void 0 ? void 0 : r._$AD) === i)
      ...
      const s = new qo(i, this), a = s.u(this.options);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const en = (e, t) => t.kind === "method" && t.descriptor && !("value" in t.descriptor) ? { ...t, finisher(r) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const on = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, nn = (e) => (...t) => ({ _$litDirective$: e, values: t });
class sn {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const G = nn(class extends sn {
  constructor(e) {
    var t;
    if (super(e), e.type !== on.ATTRIBUTE || e.name !== "class" || ((t = e.strings) === null || t === void 0 ? void 0 : t.length) > 2)
...
const uo = (e, t, r) => Math.min(Math.max(r, e), t), Z = {
  ...
  repeat: 0,
  easing: "ease"
}, me = (e) => typeof e == "number", Et = (e) => Array.isArray(e) && !me(e[0]), ln = (e, t, r) => {
  const n = t - e;
  return ((r - e) % n + n) % n + e;
};
function cn(e, t) {
...
const po = (e) => Array.isArray(e) && me(e[0]), cr = (e) => typeof e == "object" && !!e.createAnimation, It = (e) => typeof e == "function", un = (e) => typeof e == "string", zt = {
  ms: (e) => e * 1e3,
  s: (e) => e / 1e3
}, wo = (e, t, r) => (((1 - 3 * r + 3 * t) * e + (3 * r - 6 * t)) * e + 3 * t) * e, mn = 1e-7, gn = 12;
...
jo.env.NODE_ENV !== "production" && (dr = function(e, t) {
  if (!e)
    throw new Error(t);
});
class vn {
...
const Cn = (e, t) => fe.indexOf(e) - fe.indexOf(t), En = new Set(fe), yo = (e) => En.has(e), An = (e, t) => {
  ge[t] && (t = ge[t]);
  const { transforms: r } = bo(e);
  an(r, t), e.style.transform = _n(r);
}, _n = (e) => e.sort(Cn).reduce(On, "").trim(), On = (e, t) => `${e} ${t}(var(${yr(t)}))`, hr = (e) => e.startsWith("--"), Wr = /* @__PURE__ */ new Set();
function kn(e) {
  if (!Wr.has(e)) {
    Wr.add(e);
    try {
...
const In = 0.015, Tn = (e, t) => {
  let r = "";
  const n = Math.round(t / In);
  for (let o = 0; o < n; o++)
    r += e(br(0, n - 1, o)) + ", ";
  return r.substring(0, r.length - 2);
}, zr = (e, t) => It(e) ? Ct.linearEasing() ? `linear(${Tn(e, t)})` : Z.easing : po(e) ? Pn(e) : e, Pn = ([e, t, r, n]) => `cubic-bezier(${e}, ${t}, ${r}, ${n})`;
function Mn(e, t) {
...
function Nn(e, t, r, n = {}, o) {
  ...
  let v = Ct.waapi();
  w && An(e, t);
  const E = ur(t), M = bn(y.values, E), S = qt.get(E);
  return xo(M.animation, !(cr(h) && M.generator) && n.record !== !1), () => {
    ...
    if (hr(E) && (Ct.cssRegisterProperty() ? kn(E) : v = !1), w && !Ct.linearEasing() && (It(h) || Et(h) && h.some(It)) && (v = !1), v) {
...
const Un = (e) => e(), $o = (e, t, r = Z.duration) => new Proxy({
  animations: e.map(Un).filter(Boolean),
  duration: r,
  options: t
}, Wn), jn = (e) => e.animations[0], Wn = {
  get: (e, t) => {
    const r = jn(e);
    switch (t) {
      case "duration":
...
const ei = new RegExp("^" + Yt + "$"), ri = new RegExp("^" + Po + "$"), oi = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
var Mo = {};
const mr = F, So = 1335, ni = 21522, Zr = mr.getBCHDigit(So);
...
var pi = Lo.exports;
(function(e) {
  const t = at, r = si, n = li, o = ui, i = fi, s = q, a = F, l = pi;
  function c(u) {
...
const $e = F, Re = be, wi = Yn, vi = Jn, bi = Ao, yi = _o, gr = Oo, fr = ye, xi = Qn, we = To, $i = Mo, Ci = at, Le = Ro;
function Ei(e, t) {
...
function Ne(e, t, r) {
  const n = e.size, o = $i.getEncodedBits(t, r);
  let i, s;
  for (i = 0; i < 15; i++)
...
function Ti(e, t, r) {
  const n = $e.getSymbolTotalCodewords(t), o = fr.getTotalCodewordsCount(t, r), i = n - o, s = fr.getBlocksCount(t, r), a = n % s, l = s - a, c = Math.floor(n / s), d = Math.floor(i / s), b = d + 1, h = c - d, f = new xi(h);
  let p = 0;
...
`
  ...
  const s = Ii(t, r, o), a = $e.getSymbolSize(t), l = new vi(a);
  return Ei(l, t), Ai(l), _i(l, t), Ne(l, r, 0), t >= 7 && Oi(l, t), ki(l, s), isNaN(n) && (n = gr.getBestMask(
    l,
    Ne.bind(null, l, r)
...
Co.create = function(t, r) {
  ...
  let n = Re.M, o, i;
  return typeof r < "u" && (n = Re.from(r.errorCorrectionLevel, Re.M), o = we.from(r.version), i = gr.from(r.maskPattern), r.toSJISFunc && $e.setToSJISFunction(r.toSJISFunc)), Pi(t, o, n, i);
};
var No = {}, Er = {};
(function(e) {
  function t(r) {
...
Bo.render = function(t, r, n) {
  const o = Mi.getOptions(r), i = t.modules.size, s = t.modules.data, a = i + o.margin * 2, l = o.color.light.a ? "<path " + Vr(o.color.light, "fill") + ' d="M0 0h' + a + "v" + a + 'H0z"/>' : "", c = "<path " + Vr(o.color.dark, "stroke") + ' d="' + Si(s, i, o.margin) + '"/>', d = 'viewBox="0 0 ' + a + " " + a + '"', h = '<svg xmlns="http://www.w3.org/2000/svg" ' + (o.width ? 'width="' + o.width + '" height="' + o.width + '" ' : "") + d + ' shape-rendering="crispEdges">' + l + c + `</svg>
`;
  return typeof n == "function" && n(null, h), h;
};
const Ri = Kn, pr = Co, Do = No, Li = Bo;
...
var Ni = Object.defineProperty, Kr = Object.getOwnPropertySymbols, Bi = Object.prototype.hasOwnProperty, Di = Object.prototype.propertyIsEnumerable, qr = (e, t, r) => t in e ? Ni(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, De = (e, t) => {
  for (var r in t || (t = {}))
    Bi.call(t, r) && qr(e, r, t[r]);
  if (Kr)
    for (var r of Kr(t))
      Di.call(t, r) && qr(e, r, t[r]);
  return e;
};
function Ui() {
  var e;
...
Q.styles = [O.globalCss, ji], wt([$({ type: Boolean })], Q.prototype, "disabled", 2), wt([$()], Q.prototype, "iconLeft", 2), wt([$()], Q.prototype, "iconRight", 2), wt([$()], Q.prototype, "onClick", 2), wt([$()], Q.prototype, "variant", 2), Q = wt([k("wcm-button")], Q);
...
var Fi = Object.defineProperty, Zi = Object.getOwnPropertyDescriptor, Ue = (e, t, r, n) => {
...
Lt.styles = [O.globalCss, zi], Ue([$({ type: Boolean })], Lt.prototype, "disabled", 2), Ue([$()], Lt.prototype, "variant", 2), Lt = Ue([k("wcm-button-big")], Lt);
...
var Ki = Object.defineProperty, qi = Object.getOwnPropertyDescriptor, Yi = (e, t, r, n) => {
...
var es = Object.defineProperty, rs = Object.getOwnPropertyDescriptor, os = (e, t, r, n) => {
...
var is = Object.defineProperty, ss = Object.getOwnPropertyDescriptor, as = (e, t, r, n) => {
...
var cs = Object.defineProperty, ds = Object.getOwnPropertyDescriptor, Nt = (e, t, r, n) => {
...
ct.styles = [O.globalCss, ls], Nt([$()], ct.prototype, "title", 2), Nt([$()], ct.prototype, "onAction", 2), Nt([$()], ct.prototype, "actionIcon", 2), Nt([$({ type: Boolean })], ct.prototype, "border", 2), ct = Nt([k("wcm-modal-header")], ct);
...
var us = Object.defineProperty, ms = Object.getOwnPropertyDescriptor, Fe = (e, t, r, n) => {
...
Bt.styles = [O.globalCss, hs], Fe([H()], Bt.prototype, "view", 2), Fe([H()], Bt.prototype, "prevView", 2), Bt = Fe([k("wcm-modal-router")], Bt);
...
var fs = Object.defineProperty, ps = Object.getOwnPropertyDescriptor, Jr = (e, t, r, n) => {
...
const bs = { generate(e, t, r) {
  const n = "#141414", o = "#ffffff", i = [], s = vs(e, "Q"), a = t / s.length, l = [{ x: 0, y: 0 }, { x: 1, y: 0 }, { x: 0, y: 1 }];
  l.forEach(({ x: p, y: g }) => {
...
var xs = Object.defineProperty, $s = Object.getOwnPropertyDescriptor, vt = (e, t, r, n) => {
...
X.styles = [O.globalCss, ys], vt([$()], X.prototype, "uri", 2), vt([$({ type: Number })], X.prototype, "size", 2), vt([$()], X.prototype, "imageId", 2), vt([$()], X.prototype, "walletId", 2), vt([$()], X.prototype, "imageUrl", 2), X = vt([k("wcm-qrcode")], X);
...
var Es = Object.defineProperty, As = Object.getOwnPropertyDescriptor, Qr = (e, t, r, n) => {
...
var Os = Object.defineProperty, ks = Object.getOwnPropertyDescriptor, Is = (e, t, r, n) => {
...
var Ps = Object.defineProperty, Ms = Object.getOwnPropertyDescriptor, Ke = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Ms(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
Dt.styles = [O.globalCss, Ts], Ke([$()], Dt.prototype, "variant", 2), Ke([$()], Dt.prototype, "color", 2), Dt = Ke([k("wcm-text")], Dt);
...
var Rs = Object.defineProperty, Ls = Object.getOwnPropertyDescriptor, tt = (e, t, r, n) => {
...
V.styles = [O.globalCss, Ss], tt([$()], V.prototype, "onClick", 2), tt([$()], V.prototype, "name", 2), tt([$()], V.prototype, "walletId", 2), tt([$()], V.prototype, "label", 2), tt([$()], V.prototype, "imageId", 2), tt([$({ type: Boolean })], V.prototype, "installed", 2), tt([$({ type: Boolean })], V.prototype, "recent", 2), V = tt([k("wcm-wallet-button")], V);
...
var Bs = Object.defineProperty, Ds = Object.getOwnPropertyDescriptor, ne = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Ds(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
bt.styles = [O.globalCss, Ns], ne([$()], bt.prototype, "walletId", 2), ne([$()], bt.prototype, "imageId", 2), ne([$()], bt.prototype, "imageUrl", 2), bt = ne([k("wcm-wallet-image")], bt);
var Us = Object.defineProperty, js = Object.getOwnPropertyDescriptor, Xr = (e, t, r, n) => {
...
var Ws = Object.defineProperty, Hs = Object.getOwnPropertyDescriptor, zs = (e, t, r, n) => {
...
var Zs = Object.defineProperty, Vs = Object.getOwnPropertyDescriptor, Ks = (e, t, r, n) => {
...
var Ys = Object.defineProperty, Js = Object.getOwnPropertyDescriptor, yt = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Js(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
et.styles = [O.globalCss, qs], yt([$()], et.prototype, "walletId", 2), yt([$()], et.prototype, "imageId", 2), yt([$({ type: Boolean })], et.prototype, "isError", 2), yt([$({ type: Boolean })], et.prototype, "isStale", 2), yt([$()], et.prototype, "label", 2), et = yt([k("wcm-connector-waiting")], et);
...
var Qs = Object.defineProperty, Xs = Object.getOwnPropertyDescriptor, ta = (e, t, r, n) => {
...
var ra = Object.defineProperty, oa = Object.getOwnPropertyDescriptor, na = (e, t, r, n) => {
...
var da = Object.defineProperty, ha = Object.getOwnPropertyDescriptor, Xe = (e, t, r, n) => {
...
Ut.styles = [O.globalCss, ca], Xe([H()], Ut.prototype, "open", 2), Xe([H()], Ut.prototype, "active", 2), Ut = Xe([k("wcm-modal")], Ut);
const ua = I`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`;
var ma = Object.defineProperty, ga = Object.getOwnPropertyDescriptor, jt = (e, t, r, n) => {
...
dt.styles = [O.globalCss, ua], jt([$({ type: Boolean })], dt.prototype, "isMobile", 2), jt([$({ type: Boolean })], dt.prototype, "isDesktop", 2), jt([$({ type: Boolean })], dt.prototype, "isWeb", 2), jt([$({ type: Boolean })], dt.prototype, "isRetry", 2), dt = jt([k("wcm-platform-selection")], dt);
...
var pa = Object.defineProperty, wa = Object.getOwnPropertyDescriptor, va = (e, t, r, n) => {
...
var ya = Object.defineProperty, xa = Object.getOwnPropertyDescriptor, ie = (e, t, r, n) => {
...
xt.styles = [O.globalCss, ba], ie([$()], xt.prototype, "walletId", 2), ie([$()], xt.prototype, "imageId", 2), ie([H()], xt.prototype, "uri", 2), xt = ie([k("wcm-walletconnect-qr")], xt);
var $a = Object.defineProperty, Ca = Object.getOwnPropertyDescriptor, Ea = (e, t, r, n) => {
...
var _a = Object.defineProperty, Oa = Object.getOwnPropertyDescriptor, eo = (e, t, r, n) => {
  for (var o = n > 1 ? void 0 : n ? Oa(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o);
...
se.styles = [O.globalCss, Aa], eo([H()], se.prototype, "isError", 2), se = eo([k("wcm-desktop-connecting-view")], se);
...
var Ia = Object.defineProperty, Ta = Object.getOwnPropertyDescriptor, Pa = (e, t, r, n) => {
...
var Sa = Object.defineProperty, Ra = Object.getOwnPropertyDescriptor, ro = (e, t, r, n) => {
...
ae.styles = [O.globalCss, Ma], ro([H()], ae.prototype, "isError", 2), ae = ro([k("wcm-mobile-connecting-view")], ae);
...
var Na = Object.defineProperty, Ba = Object.getOwnPropertyDescriptor, Da = (e, t, r, n) => {
...
var Ua = Object.defineProperty, ja = Object.getOwnPropertyDescriptor, Wa = (e, t, r, n) => {
...
var za = Object.defineProperty, Fa = Object.getOwnPropertyDescriptor, Wt = (e, t, r, n) => {
...
ht.styles = [O.globalCss, Ha], Wt([H()], ht.prototype, "loading", 2), Wt([H()], ht.prototype, "firstFetch", 2), Wt([H()], ht.prototype, "search", 2), Wt([H()], ht.prototype, "endReached", 2), ht = Wt([k("wcm-wallet-explorer-view")], ht);
...
var Va = Object.defineProperty, Ka = Object.getOwnPropertyDescriptor, oo = (e, t, r, n) => {
