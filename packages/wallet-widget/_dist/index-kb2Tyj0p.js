...
let no = class {
  ...
  get styleSheet() {
    ...
    if (wr && t === void 0) {
      ...
      n && (t = _r.get(r)),
        t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), n && _r.set(r, t))
    }
    return t
  }
  toString() {
...
const Ho = (e) => new no(typeof e == "string" ? e : e + "", void 0, vr),
  I = (e, ...t) => {
    const r =
      e.length === 1
        ? e[0]
...
const he = window,
  kr = he.trustedTypes,
  Fo = kr ? kr.emptyScript : "",
  Ir = he.reactiveElementPolyfillSupport,
  sr = {
    toAttribute(e, t) {
      switch (t) {
        case Boolean:
  ...
  io = (e, t) => t !== e && (t == t || e == e),
  Ee = { attribute: !0, type: String, converter: sr, reflect: !1, hasChanged: io },
  ar = "finalized"
let $t = class extends HTMLElement {
  ...
  createRenderRoot() {
    ...
    return zo(r, this.constructor.elementStyles), r
  }
  connectedCallback() {
    var t
  ...
  _$EO(t, r, n = Ee) {
    ...
    if (i !== void 0 && n.reflect === !0) {
      const s = (
        ((o = n.converter) === null || o === void 0 ? void 0 : o.toAttribute) !== void 0 ? n.converter : sr
      ...
      const s = o.getPropertyOptions(i),
        a =
          typeof s.converter == "function"
            ...
            : ((n = s.converter) === null || n === void 0 ? void 0 : n.fromAttribute) !== void 0
              ? s.converter
              : sr
  ...
  requestUpdate(t, r, n) {
    let o = !0
    t !== void 0 &&
      (((n = n || this.constructor.getPropertyOptions(t)).hasChanged || io)(this[t], r)
        ? (this._$AL.has(t) || this._$AL.set(t, r),
          n.reflect === !0 &&
            this._$El !== t &&
            (this._$EC === void 0 && (this._$EC = /* @__PURE__ */ new Map()), this._$EC.set(t, n)))
        : (o = !1)),
...
;($t[ar] = !0),
  ($t.elementProperties = /* @__PURE__ */ new Map()),
  ($t.elementStyles = []),
  ($t.shadowRootOptions = { mode: "open" }),
  Ir == null || Ir({ ReactiveElement: $t }),
...
const ue = window,
  Ot = ue.trustedTypes,
  Tr = Ot ? Ot.createPolicy("lit-html", { createHTML: (e) => e }) : void 0,
  lr = "$lit$",
  ...
  ao = Array.isArray,
  Vo = (e) => ao(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function",
  _e = `[ 	
\f\r]`,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  Sr = /'/g,
  Rr = /"/g,
  lo = /^(?:script|style|textarea|title)$/i,
  co =
    (e) =>
  ...
  for (let a = 0; a < r; a++) {
        ...
        s === Rt
          ? d[1] === "!--"
            ...
            : d[1] !== void 0
              ? (s = Mr)
              : d[2] !== void 0
                ? (lo.test(d[2]) && (o = RegExp("</" + d[2], "g")), (s = lt))
                : d[3] !== void 0 && (s = lt)
          : s === lt
            ? d[0] === ">"
              ? ((s = o ?? Rt), (b = -1))
              : d[1] === void 0
                ? (b = -2)
                : ((b = s.lastIndex - d[2].length), (c = d[1]), (s = d[3] === void 0 ? lt : d[3] === '"' ? Rr : Sr))
            : s === Rr || s === Sr
              ? (s = lt)
              : s === Pr || s === Mr
                ? (s = Rt)
    ...
    i +=
      s === Rt
        ? l + Zo
        : b >= 0
          ? (n.push(c), l.slice(0, b) + lr + l.slice(b) + rt + f)
          : l + rt + (b === -2 ? (n.push(void 0), a) : f)
  }
      ...
      if (o.nodeType === 1) {
          ...
          for (const h of o.getAttributeNames())
            if (h.endsWith(lr) || h.startsWith(rt)) {
              ...
              if ((b.push(h), f !== void 0)) {
                const p = o.getAttribute(f.toLowerCase() + lr).split(rt),
                  g = /([.?@])?(.*)/.exec(f)
                l.push({
                  type: 1,
                  index: i,
        ...
        if (lo.test(o.tagName)) {
          ...
          if (h > 0) {
            ...
            for (let f = 0; f < h; f++) o.append(b[f], Zt()), ut.nextNode(), l.push({ type: 2, index: ++i })
            o.append(b[h], Zt())
          }
        }
      } else if (o.nodeType === 8)
        if (o.data === so) l.push({ type: 2, index: i })
        else {
          let b = -1
          for (; (b = o.data.indexOf(rt, b + 1)) !== -1; ) l.push({ type: 7, index: i }), (b += rt.length - 1)
        }
      i++
    }
  }
...
function kt(e, t, r = e, n) {
  ...
  return (
    (l == null ? void 0 : l.constructor) !== c &&
      ((i = l == null ? void 0 : l._$AO) === null || i === void 0 || i.call(l, !1),
      c === void 0 ? (l = void 0) : ((l = new c(e)), l._$AT(e, r, n)),
      n !== void 0 ? (((s = (a = r)._$Co) !== null && s !== void 0 ? s : (a._$Co = []))[n] = l) : (r._$Cl = l)),
    l !== void 0 && (t = kt(e, l._$AS(e, t.values), l, n)),
    t
  )
}
class qo {
  ...
  u(t) {
    ...
    const {
      ...
      i = ((r = t == null ? void 0 : t.creationScope) !== null && r !== void 0 ? r : ft).importNode(n, !0)
    ut.currentNode = i
    let s = ut.nextNode(),
      a = 0,
      l = 0,
    ...
    for (; c !== void 0; ) {
      if (a === c.index) {
        let d
        c.type === 2
          ? (d = new Jt(s, s.nextSibling, this, t))
          : c.type === 1
            ? (d = new c.ctor(s, c.name, c.strings, this, t))
            : c.type === 6 && (d = new Xo(s, this, t)),
          this._$AV.push(d),
          (c = o[++l])
      }
  ...
  g(t) {
    ...
    const { values: n, _$litType$: o } = t,
      i =
        typeof o == "number"
          ? this._$AC(t)
          : (o.el === void 0 && (o.el = Kt.createElement(ho(o.h, o.h[0]), this.options)), o)
    if (((r = this._$AH) === null || r === void 0 ? void 0 : r._$AD) === i) this._$AH.v(n)
    else {
      const s = new qo(i, this),
        a = s.u(this.options)
...
const Jo = Ot ? Ot.emptyScript : ""
let Go = class extends ve {
  constructor() {
    super(...arguments), (this.type = 4)
  }
  j(t) {
    t && t !== B ? this.element.setAttribute(this.name, Jo) : this.element.removeAttribute(this.name)
  }
}
class Qo extends ve {
  constructor(t, r, n, o, i) {
  ...
  handleEvent(t) {
    ...
    typeof this._$AH == "function"
      ? this._$AH.call(
          (n = (r = this.options) === null || r === void 0 ? void 0 : r.host) !== null && n !== void 0
            ? n
            : this.element,
          t,
        )
...
Nr == null || Nr(Kt, Jt),
  ((Ae = ue.litHtmlVersions) !== null && Ae !== void 0 ? Ae : (ue.litHtmlVersions = [])).push("2.8.0")
const tn = (e, t, r) => {
  var n, o
...
class A extends $t {
  ...
  update(t) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t),
      (this._$Do = tn(r, this.renderRoot, this.renderOptions))
  }
  connectedCallback() {
    var t
...
;(A.finalized = !0),
  (A._$litElement$ = !0),
  (Oe = globalThis.litElementHydrateSupport) === null || Oe === void 0 || Oe.call(globalThis, { LitElement: A })
const Br = globalThis.litElementPolyfillSupport
Br == null || Br({ LitElement: A })
;((ke = globalThis.litElementVersions) !== null && ke !== void 0 ? ke : (globalThis.litElementVersions = [])).push(
  "3.3.3",
)
/**
 * @license
...
function $(e) {
  return (t, r) => (r !== void 0 ? rn(e, t, r) : en(e, t))
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const on = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 },
  nn =
    (e) =>
...
const uo = (e, t, r) => Math.min(Math.max(r, e), t),
  Z = {
    duration: 0.3,
    delay: 0,
    endDelay: 0,
...
function cn(e, t) {
  return Et(e) ? e[ln(0, e.length, t)] : e
}
const mo = (e, t, r) => -r * e + r * t + e,
  go = () => {},
  it = (e) => e,
  br = (e, t, r) => (t - e === 0 ? 1 : (r - e) / (t - e))
function fo(e, t) {
...
function hn(e, t = dn(e.length), r = it) {
  const n = e.length,
    o = n - t.length
  return (
    o > 0 && fo(t, o),
    (i) => {
      ...
      return (a = cn(r, s)(a)), mo(e[s], e[s + 1], a)
    }
  )
}
const po = (e) => Array.isArray(e) && me(e[0]),
  ...
  wo = (e, t, r) => (((1 - 3 * r + 3 * t) * e + (3 * r - 6 * t)) * e + 3 * t) * e,
  mn = 1e-7,
  gn = 12
function fn(e, t, r, n, o) {
  let i,
    s,
    a = 0
  do (s = t + (r - t) / 2), (i = wo(s, n, o) - e), i > 0 ? (r = s) : (t = s)
  while (Math.abs(i) > mn && ++a < gn)
  return s
}
function Ht(e, t, r, n) {
  if (e === t && r === n) return it
  const o = (i) => fn(i, 0, 1, e, r)
...
class vo {
  constructor(
    ...
    {
      easing: n,
      duration: o = Z.duration,
      delay: i = Z.delay,
      endDelay: s = Z.endDelay,
      repeat: a = Z.repeat,
      offset: l,
      direction: c = "normal",
      autoplay: d = !0,
    ...
    const b = hn(r, l, Et(n) ? n.map(Ur) : it)
    ;(this.tick = (h) => {
      var f
      i = i
      let p = 0
      this.pauseTime !== void 0 ? (p = this.pauseTime) : (p = (h - this.startTime) * this.rate),
        (this.t = p),
        (p /= 1e3),
        (p = Math.max(p - i, 0)),
      ...
      const w = p >= this.totalDuration ? 1 : Math.min(u, 1),
        v = b(this.easing(w))
      t(v),
        this.pauseTime === void 0 && (this.playState === "finished" || p >= this.totalDuration + s)
          ? ((this.playState = "finished"), (f = this.resolve) === null || f === void 0 || f.call(this, v))
...
const Cn = (e, t) => fe.indexOf(e) - fe.indexOf(t),
  En = new Set(fe),
  yo = (e) => En.has(e),
  An = (e, t) => {
    ge[t] && (t = ge[t])
...
const Pe = (e, t) => document.createElement("div").animate(e, t),
  ...
  Me = {},
  Ct = {}
for (const e in Hr) Ct[e] = () => (Me[e] === void 0 && (Me[e] = Hr[e]()), Me[e])
const In = 0.015,
  Tn = (e, t) => {
    let r = ""
  ...
  zr = (e, t) => (It(e) ? (Ct.linearEasing() ? `linear(${Tn(e, t)})` : Z.easing) : po(e) ? Pn(e) : e),
  Pn = ([e, t, r, n]) => `cubic-bezier(${e}, ${t}, ${r}, ${n})`
function Mn(e, t) {
...
function Nn(e, t, r, n = {}, o) {
  ...
  let a,
    {
      duration: l = Z.duration,
      delay: c = Z.delay,
      endDelay: d = Z.endDelay,
      repeat: b = Z.repeat,
      easing: h = Z.easing,
      persist: f = !1,
      direction: p,
  ...
  const E = ur(t),
    ...
    S = qt.get(E)
  return (
    xo(M.animation, !(cr(h) && M.generator) && n.record !== !1),
    () => {
      const U = () => {
        var R, Y
        return (Y = (R = Xt.get(e, E)) !== null && R !== void 0 ? R : S == null ? void 0 : S.initialValue) !== null &&
          Y !== void 0
          ? Y
          : 0
      }
      ...
      if (
        (hr(E) && (Ct.cssRegisterProperty() ? kn(E) : (v = !1)),
        w && !Ct.linearEasing() && (It(h) || (Et(h) && h.some(It))) && (v = !1),
        v)
      ) {
        S && (P = P.map((D) => (me(D) ? S.toDefaultUnit(D) : D))),
          P.length === 1 && (!Ct.partialKeyframes() || s) && P.unshift(U())
        const R = {
          delay: zt.ms(c),
          duration: zt.ms(l),
          endDelay: zt.ms(d),
        ...
        a.finished
          ...
          .catch(go),
          _ || (a.playbackRate = 1.000001)
      } else if (o && w)
        (P = P.map((R) => (typeof R == "string" ? parseFloat(R) : R))),
  ...
  Wn = {
    get: (e, t) => {
      ...
      switch (t) {
        ...
        case "finished":
          return e.finished || (e.finished = Promise.all(e.animations.map(Hn)).catch(go)), e.finished
        case "stop":
          return () => {
...
function Fn(e) {
  return function (r, n, o = {}) {
    ...
    for (let a = 0; a < i; a++) {
      ...
      for (const c in n) {
        const d = Bn(o, c)
        d.delay = zn(d.delay, a, i)
        const b = Nn(l, c, n[c], d, e)
        s.push(b)
      }
    }
    return $o(
  ...
  ;(e.isValid = function (o) {
    ...
    (e.getPenaltyN1 = function (o) {
      ...
      for (let b = 0; b < i; b++) {
        ...
        for (let h = 0; h < i; h++) {
          let f = o.get(b, h)
          f === c ? a++ : (a >= 5 && (s += t.N1 + (a - 5)), (c = f), (a = 1)),
            (f = o.get(h, b)),
            f === d ? l++ : (l >= 5 && (s += t.N1 + (l - 5)), (d = f), (l = 1))
        }
...
const nt = be,
  te = [
    ...
    8, 4, 5, 8, 11, 4, 8, 10, 11, 4, 9, 12, 16, 4, 9, 16, 16, 6, 10, 12, 18, 6, 10, 17, 16, 6, 11, 16, 19, 6, 13, 18,
    21, 7, 14, 21, 25, 8, 16, 20, 25, 8, 17, 23, 25, 9, 17, 23, 34, 9, 18, 25, 30, 10, 20, 27, 32, 12, 21, 29, 35, 12,
    23, 34, 37, 12, 25, 34, 40, 13, 26, 35, 42, 14, 28, 38, 45, 15, 29, 40, 48, 16, 31, 43, 51, 17, 33, 45, 54, 18, 35,
    48, 57, 19, 37, 51, 60, 19, 38, 53, 63, 20, 40, 56, 66, 21, 43, 59, 70, 22, 45, 62, 74, 24, 47, 65, 77, 25, 49, 68,
    81,
  ],
  ee = [
    // L  M  Q  H
...
const ei = new RegExp("^" + Yt + "$"),
  ri = new RegExp("^" + Po + "$"),
  oi = new RegExp("^[A-Z0-9 $%*+\\-./:]+$")
...
;(function (e) {
  const t = F,
    ...
    a = t.getBCHDigit(s)
  function l(h, f, p) {
    for (let g = 1; g <= 40; g++) if (f <= e.getCapacity(g, p, h)) return g
  }
  function c(h, f) {
  ...
  function b(h, f) {
    for (let p = 1; p <= 40; p++) if (d(h, p) <= e.getCapacity(p, f, o.MIXED)) return p
  }
  ;(e.from = function (f, p) {
    ...
    (e.getCapacity = function (f, p, g) {
      ...
      typeof g > "u" && (g = o.BYTE)
      const _ = t.getSymbolTotalCodewords(f),
        u = r.getTotalCodewordsCount(f, p),
        y = (_ - u) * 8
...
const mr = F,
  So = 1335,
  ni = 21522,
  Zr = mr.getBCHDigit(So)
Mo.getEncodedBits = function (t, r) {
  const n = (t.bit << 3) | r
  let o = n << 10
  for (; mr.getBCHDigit(o) - Zr >= 0; ) o ^= So << (mr.getBCHDigit(o) - Zr)
  return ((n << 10) | o) ^ ni
}
var Ro = {}
const ii = at
  ...
  function b(u) {
    ...
    return (
      a.isKanjiModeEnabled()
        ? ((v = d(s.BYTE, t.BYTE, u)), (E = d(s.KANJI, t.KANJI, u)))
        : ((v = d(s.BYTE_KANJI, t.BYTE, u)), (E = [])),
      y
        .concat(w, v, E)
        .sort(function (S, U) {
    ...
    for (let M = 0; M < u.length; M++) {
      ...
      for (let P = 0; P < S.length; P++) {
        ...
        for (let Y = 0; Y < E.length; Y++) {
          const D = E[Y]
          w[D] && w[D].node.mode === z.mode
            ? ((v[D][R] = h(w[D].lastCount + z.length, z.mode) - h(w[D].lastCount, z.mode)),
              (w[D].lastCount += z.length))
            : (w[D] && (w[D].lastCount = z.length),
              (v[D][R] = h(z.length, z.mode) + 4 + t.getCharCountIndicator(z.mode, y)))
        }
      }
      E = U
    }
    for (let M = 0; M < E.length; M++) v[E[M]].end = 0
 ...
 Suggested mode is: ` +
  ...
  ;(e.fromArray = function (y) {
    ...
    (e.fromString = function (y, w) {
      const v = b(y, a.isKanjiModeEnabled()),
        E = p(v),
        M = g(E, w),
        S = l.find_path(M.map, "start", "end"),
        U = []
      for (let P = 1; P < S.length - 1; P++) U.push(M.table[S[P]].node)
...
function Ii(e, t, r) {
  ...
  r.forEach(function (l) {
    n.put(l.mode.bit, 4), n.put(l.getLength(), Ci.getCharCountIndicator(l.mode, e)), l.write(n)
  })
  const o = $e.getSymbolTotalCodewords(e),
    i = fr.getTotalCodewordsCount(e, t),
    s = (o - i) * 8
...
function Ti(e, t, r) {
  const n = $e.getSymbolTotalCodewords(t),
    o = fr.getTotalCodewordsCount(t, r),
    i = n - o,
    s = fr.getBlocksCount(t, r),
    a = n % s,
    l = s - a,
    c = Math.floor(n / s),
    d = Math.floor(i / s),
  ...
  let v = 0,
    E,
    M
  for (E = 0; E < u; E++) for (M = 0; M < s; M++) E < g[M].length && (w[v++] = g[M][E])
  for (E = 0; E < h; E++) for (M = 0; M < s; M++) w[v++] = _[M][E]
  return w
}
function Pi(e, t, r, n) {
  let o
...
`,
  ...
  return (
    ...
    t >= 7 && Oi(l, t),
    ki(l, s),
    isNaN(n) && (n = gr.getBestMask(l, Ne.bind(null, l, r))),
    gr.applyMask(n, l),
    Ne(l, r, n),
    {
      modules: l,
...
Co.create = function (t, r) {
  ...
  return (
    typeof r < "u" &&
      ((n = Re.from(r.errorCorrectionLevel, Re.M)),
      (o = we.from(r.version)),
      (i = gr.from(r.maskPattern)),
...
function Si(e, t, r) {
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    !l && !i && (i = !0),
      e[a]
        ? (s++,
          (a > 0 && l > 0 && e[a - 1]) || ((n += i ? Be("M", l + r, 0.5 + c + r) : Be("m", o, 0)), (o = 0), (i = !1)),
          (l + 1 < t && e[a + 1]) || ((n += Be("h", s)), (s = 0)))
        : o++
  }
  return n
}
Bo.render = function (t, r, n) {
  const o = Mi.getOptions(r),
    i = t.modules.size,
    s = t.modules.data,
    a = i + o.margin * 2,
    l = o.color.light.a ? "<path " + Vr(o.color.light, "fill") + ' d="M0 0h' + a + "v" + a + 'H0z"/>' : "",
    c = "<path " + Vr(o.color.dark, "stroke") + ' d="' + Si(s, i, o.margin) + '"/>',
    d = 'viewBox="0 0 ' + a + " " + a + '"',
    h =
...
function Ar(e, t, r, n, o) {
  ...
  if (!a && !Ri()) throw new Error("Callback required as last argument")
  if (a) {
    if (s < 2) throw new Error("Too few arguments provided")
    s === 2
      ? ((o = r), (r = t), (t = n = void 0))
      : s === 3 &&
        (t.getContext && typeof o > "u" ? ((o = n), (n = void 0)) : ((o = n), (n = r), (r = t), (t = void 0)))
  } else {
    if (s < 1) throw new Error("Too few arguments provided")
    return (
      s === 1 ? ((r = t), (t = n = void 0)) : s === 2 && !t.getContext && ((n = r), (r = t), (t = void 0)),
...
var Ni = Object.defineProperty,
  ...
  De = (e, t) => {
    for (var r in t || (t = {})) Bi.call(t, r) && qr(e, r, t[r])
    if (Kr) for (var r of Kr(t)) Di.call(t, r) && qr(e, r, t[r])
    return e
  }
function Ui() {
  var e
...
const O = {
  ...
  ji = I`button{border-radius:var(--wcm-secondary-button-border-radius);height:28px;padding:0 10px;background-color:var(--wcm-accent-color)}button path{fill:var(--wcm-accent-fill-color)}button::after{border-radius:inherit;border:1px solid var(--wcm-color-overlay)}button:disabled::after{background-color:transparent}.wcm-icon-left svg{margin-right:5px}.wcm-icon-right svg{margin-left:5px}button:active::after{background-color:var(--wcm-color-overlay)}.wcm-ghost,.wcm-ghost:active::after,.wcm-outline{background-color:transparent}.wcm-ghost:active{opacity:.5}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}.wcm-ghost:hover::after{background-color:transparent}.wcm-ghost:hover{opacity:.5}}button:disabled{background-color:var(--wcm-color-bg-3);pointer-events:none}.wcm-ghost::after{border-color:transparent}.wcm-ghost path{fill:var(--wcm-color-fg-2)}.wcm-outline path{fill:var(--wcm-accent-color)}.wcm-outline:disabled{background-color:transparent;opacity:.5}`
var Wi = Object.defineProperty,
  Hi = Object.getOwnPropertyDescriptor,
  wt = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? Hi(t, r) : t, i = e.length - 1, s; i >= 0; i--)
...
;(Q.styles = [O.globalCss, ji]),
  ...
  (Q = wt([k("wcm-button")], Q))
const zi = I`:host{display:inline-block}button{padding:0 15px 1px;height:40px;border-radius:var(--wcm-button-border-radius);color:var(--wcm-accent-fill-color);background-color:var(--wcm-accent-color)}button::after{content:'';top:0;bottom:0;left:0;right:0;position:absolute;background-color:transparent;border-radius:inherit;transition:background-color .2s ease;border:1px solid var(--wcm-color-overlay)}button:active::after{background-color:var(--wcm-color-overlay)}button:disabled{padding-bottom:0;background-color:var(--wcm-color-bg-3);color:var(--wcm-color-fg-3)}.wcm-secondary{color:var(--wcm-accent-color);background-color:transparent}.wcm-secondary::after{display:none}@media(hover:hover){button:hover::after{background-color:var(--wcm-color-overlay)}}`
...
;(je.styles = [O.globalCss, Vi]), (je = Yi([k("wcm-info-footer")], je))
const T = {
  ...
  Ji = I`.wcm-toolbar-placeholder{top:0;bottom:0;left:0;right:0;width:100%;position:absolute;display:block;pointer-events:none;height:100px;border-radius:calc(var(--wcm-background-border-radius) * .9);background-color:var(--wcm-background-color);background-position:center;background-size:cover}.wcm-toolbar{height:38px;display:flex;position:relative;margin:5px 15px 5px 5px;justify-content:space-between;align-items:center}.wcm-toolbar img,.wcm-toolbar svg{height:28px;object-position:left center;object-fit:contain}#wcm-wc-logo path{fill:var(--wcm-accent-fill-color)}button{width:28px;height:28px;border-radius:var(--wcm-icon-button-border-radius);border:0;display:flex;justify-content:center;align-items:center;cursor:pointer;background-color:var(--wcm-color-bg-1);box-shadow:0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-bg-2)}button svg{display:block;object-position:center}button path{fill:var(--wcm-color-fg-1)}.wcm-toolbar div{display:flex}@media(hover:hover){button:hover{background-color:var(--wcm-color-bg-2)}}`
...
;(We.styles = [O.globalCss, Ji]), (We = Xi([k("wcm-modal-backcard")], We))
const ts = I`main{padding:20px;padding-top:0;width:100%}`
...
;(He.styles = [O.globalCss, ts]), (He = os([k("wcm-modal-content")], He))
const ns = I`footer{padding:10px;display:flex;flex-direction:column;align-items:inherit;justify-content:inherit;border-top:1px solid var(--wcm-color-bg-2)}`
...
;(ze.styles = [O.globalCss, ns]), (ze = as([k("wcm-modal-footer")], ze))
...
const x = {
    ...
    goToConnectingView(e) {
      N.setData({ Wallet: e })
      const t = C.isMobile(),
        { isDesktop: r, isWeb: n, isMobile: o } = x.getCachedRouterWalletPlatforms()
      t
        ? o
  ...
  hs = I`.wcm-router{overflow:hidden;will-change:transform}.wcm-content{display:flex;flex-direction:column}`
...
let Bt = class extends A {
  ...
  firstUpdated() {
    ;(this.resizeObserver = new ResizeObserver(([e]) => {
      ...
      this.oldHeight !== "0px" && mt(this.routerEl, { height: [this.oldHeight, t] }, { duration: 0.2 }),
        (this.oldHeight = t)
    })),
  ...
  async onChangeRoute() {
    await mt(this.routerEl, { opacity: [1, 0], scale: [1, 1.02] }, { duration: 0.15, delay: 0.1 }).finished,
      (this.view = N.state.view),
      mt(this.routerEl, { opacity: [0, 1], scale: [0.99, 1] }, { duration: 0.37, delay: 0.05 })
  }
  render() {
    return m`<div class="wcm-router"><div class="wcm-content">${this.viewTemplate()}</div></div>`
  }
}
;(Bt.styles = [O.globalCss, hs]),
  Fe([H()], Bt.prototype, "view", 2),
  Fe([H()], Bt.prototype, "prevView", 2),
  (Bt = Fe([k("wcm-modal-router")], Bt))
const gs = I`div{height:36px;width:max-content;display:flex;justify-content:center;align-items:center;padding:9px 15px 11px;position:absolute;top:12px;box-shadow:0 6px 14px -6px rgba(10,16,31,.3),0 10px 32px -4px rgba(10,16,31,.15);z-index:2;left:50%;transform:translateX(-50%);pointer-events:none;backdrop-filter:blur(20px) saturate(1.8);-webkit-backdrop-filter:blur(20px) saturate(1.8);border-radius:var(--wcm-notification-border-radius);border:1px solid var(--wcm-color-overlay);background-color:var(--wcm-color-overlay)}svg{margin-right:5px}@-moz-document url-prefix(){div{background-color:var(--wcm-color-bg-3)}}.wcm-success path{fill:var(--wcm-accent-color)}.wcm-error path{fill:var(--wcm-error-color)}`
...
let re = class extends A {
  constructor() {
    super(),
      ...
      (this.unsubscribe = ot.subscribe((e) => {
        e.open
          ? ((this.open = !0), (this.timeout = setTimeout(() => ot.closeToast(), 2200)))
  ...
  render() {
    ...
    return this.open
      ? m`<div class="${G(r)}">${t === "success" ? T.CHECKMARK_ICON : null} ${t === "error" ? T.CROSS_ICON : null}<wcm-text variant="small-regular">${e}</wcm-text></div>`
      : null
  }
}
;(re.styles = [O.globalCss, gs]), Jr([H()], re.prototype, "open", 2), (re = Jr([k("wcm-modal-toast")], re))
const ws = 0.1,
  Gr = 2.5,
  J = 7
function Ze(e, t, r) {
  return e === t ? !1 : (e - t < 0 ? t - e : e - t) <= r + ws
}
function vs(e, t) {
  const r = Array.prototype.slice.call(Gt.create(e, { errorCorrectionLevel: t }).modules.data, 0),
...
const bs = {
    generate(e, t, r) {
      ...
      l.forEach(({ x: p, y: g }) => {
        const _ = (s.length - J) * a * p,
          u = (s.length - J) * a * g,
          y = 0.45
        for (let w = 0; w < l.length; w += 1) {
          const v = a * (J - w * 2)
          i.push(
            L`<rect fill="${w % 2 === 0 ? n : o}" height="${v}" rx="${v * y}" ry="${v * y}" width="${v}" x="${_ + a * w}" y="${u + a * w}">`,
          )
        }
      })
      ...
      s.forEach((p, g) => {
        p.forEach((_, u) => {
          if (
            s[g][u] &&
            !((g < J && u < J) || (g > s.length - (J + 1) && u < J) || (g < J && u > s.length - (J + 1))) &&
            !(g > d && g < b && u > d && u < b)
          ) {
            const y = g * a + a / 2,
              w = u * a + a / 2
      ...
      return (
        ...
        Object.entries(f)
          ...
          .forEach(([p, g]) => {
            g.forEach(([_, u]) => {
              i.push(
                L`<line x1="${p}" x2="${p}" y1="${_}" y2="${u}" stroke="${n}" stroke-width="${a / (Gr / 2)}" stroke-linecap="round">`,
              )
            })
          }),
        i
...
let X = class extends A {
  ...
  svgTemplate() {
    ...
    return L`<svg height="${e}" width="${e}">${bs.generate(this.uri, e, e / 4)}</svg>`
  }
  render() {
...
;(oe.styles = [O.globalCss, Cs]), Qr([$()], oe.prototype, "onChange", 2), (oe = Qr([k("wcm-search-input")], oe))
...
;(V.styles = [O.globalCss, Ss]),
  tt([$()], V.prototype, "onClick", 2),
  tt([$()], V.prototype, "name", 2),
  tt([$()], V.prototype, "walletId", 2),
  tt([$()], V.prototype, "label", 2),
  tt([$()], V.prototype, "imageId", 2),
  tt([$({ type: Boolean })], V.prototype, "installed", 2),
  tt([$({ type: Boolean })], V.prototype, "recent", 2),
  (V = tt([k("wcm-wallet-button")], V))
...
;(Ye.styles = [O.globalCss, Fs]), (Ye = Ks([k("wcm-android-wallet-selection")], Ye))
...
let et = class extends A {
  ...
  svgLoaderTemplate() {
    var e, t
    const r =
      (t = (e = _t.state.themeVariables) == null ? void 0 : e["--wcm-wallet-icon-large-border-radius"]) != null
        ? t
...
;(et.styles = [O.globalCss, qs]),
  ...
  (et = yt([k("wcm-connector-waiting")], et))
const At = {
    manualWallets() {
      var e, t
      const { mobileWallets: r, desktopWallets: n } = gt.state,
        ...
        i = C.isMobile() ? r : n,
        s = i == null ? void 0 : i.filter((a) => o !== a.id)
      return (t = C.isMobile()
        ? s == null
          ? void 0
          : s.map(({ id: a, name: l, links: c }) => ({ id: a, name: l, mobile: c, links: c }))
        : s == null
          ? void 0
          : s.map(({ id: a, name: l, links: c }) => ({ id: a, name: l, desktop: c, links: c }))) != null
        ? t
        : []
    },
    recentWallet() {
  ...
  st = {
    ...
    recomendedWalletsTemplate(e = !1) {
      return At.recomendedWallets(e).map(
        (t) =>
          m`<wcm-wallet-button name="${t.name}" walletId="${t.id}" imageId="${t.image_id}" .onClick="${() => this.onConnecting(t)}"></wcm-wallet-button>`,
      )
    },
...
let Je = class extends A {
  render() {
    const { explorerExcludedWalletIds: e, enableExplorer: t } = gt.state,
      r = e !== "ALL" && t,
      n = st.manualWalletsTemplate(),
      o = st.recomendedWalletsTemplate()
...
;(Je.styles = [O.globalCss, Gs]), (Je = ta([k("wcm-desktop-wallet-selection")], Je))
const ea = I`div{background-color:var(--wcm-color-bg-2);padding:10px 20px 15px 20px;border-top:1px solid var(--wcm-color-bg-3);text-align:center}a{color:var(--wcm-accent-color);text-decoration:none;transition:opacity .2s ease-in-out;display:inline}a:active{opacity:.8}@media(hover:hover){a:hover{opacity:.8}}`
var ra = Object.defineProperty,
  oa = Object.getOwnPropertyDescriptor,
  na = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? oa(t, r) : t, i = e.length - 1, s; i >= 0; i--)
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o)
...
let Ge = class extends A {
  render() {
    ...
    return e ?? t
      ? m`<div><wcm-text variant="small-regular" color="secondary">By connecting your wallet to this app, you agree to the app's ${e ? m`<a href="${e}" target="_blank" rel="noopener noreferrer">Terms of Service</a>` : null} ${e && t ? "and" : null} ${t ? m`<a href="${t}" target="_blank" rel="noopener noreferrer">Privacy Policy</a>` : null}</wcm-text></div>`
      : null
  }
}
;(Ge.styles = [O.globalCss, ea]), (Ge = na([k("wcm-legal-notice")], Ge))
const ia = I`div{display:grid;grid-template-columns:repeat(4,80px);margin:0 -10px;justify-content:space-between;row-gap:10px}`
...
;(Qe.styles = [O.globalCss, ia]), (Qe = la([k("wcm-mobile-wallet-selection")], Qe))
...
let Ut = class extends A {
  ...
  onOpenModalEvent() {
    this.toggleBodyScroll(!1),
      ...
      (this.open = !0),
      setTimeout(async () => {
        const e = x.isMobileAnimation() ? { y: ["50vh", "0vh"] } : { scale: [0.98, 1] },
          t = 0.1,
          r = 0.2
        await Promise.all([
          mt(this.overlayEl, { opacity: [0, 1] }, { delay: t, duration: r }).finished,
  ...
  async onCloseModalEvent() {
    ...
    const e = x.isMobileAnimation() ? { y: ["0vh", "50vh"] } : { scale: [1, 0.98] },
      t = 0.2
    await Promise.all([
    ...
    ;(this.abortController = new AbortController()),
      window.addEventListener(
        ...
        (e) => {
          ...
          e.key === "Escape"
            ? ce.close()
            : e.key === "Tab" && (((t = e.target) != null && t.tagName.includes("wcm-")) || this.containerEl.focus())
        },
...
;(Ut.styles = [O.globalCss, ca]),
  Xe([H()], Ut.prototype, "open", 2),
  Xe([H()], Ut.prototype, "active", 2),
  (Ut = Xe([k("wcm-modal")], Ut))
const ua = I`div{display:flex;margin-top:15px}slot{display:inline-block;margin:0 5px}wcm-button{margin:0 5px}`
var ma = Object.defineProperty,
  ga = Object.getOwnPropertyDescriptor,
  jt = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? ga(t, r) : t, i = e.length - 1, s; i >= 0; i--)
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o)
...
;(dt.styles = [O.globalCss, ua]),
  jt([$({ type: Boolean })], dt.prototype, "isMobile", 2),
  jt([$({ type: Boolean })], dt.prototype, "isDesktop", 2),
  jt([$({ type: Boolean })], dt.prototype, "isWeb", 2),
  jt([$({ type: Boolean })], dt.prototype, "isRetry", 2),
  (dt = jt([k("wcm-platform-selection")], dt))
const fa = I`button{display:flex;flex-direction:column;padding:5px 10px;border-radius:var(--wcm-button-hover-highlight-border-radius);height:100%;justify-content:flex-start}.wcm-icons{width:60px;height:60px;display:flex;flex-wrap:wrap;padding:7px;border-radius:var(--wcm-wallet-icon-border-radius);justify-content:space-between;align-items:center;margin-bottom:5px;background-color:var(--wcm-color-bg-2);box-shadow:inset 0 0 0 1px var(--wcm-color-overlay)}button:active{background-color:var(--wcm-color-overlay)}@media(hover:hover){button:hover{background-color:var(--wcm-color-overlay)}}.wcm-icons img{width:21px;height:21px;object-fit:cover;object-position:center;border-radius:calc(var(--wcm-wallet-icon-border-radius)/ 2);border:1px solid var(--wcm-color-overlay)}.wcm-icons svg{width:21px;height:21px}.wcm-icons img:nth-child(1),.wcm-icons img:nth-child(2),.wcm-icons svg:nth-child(1),.wcm-icons svg:nth-child(2){margin-bottom:4px}wcm-text{width:100%;text-align:center}#wallet-placeholder-fill{fill:var(--wcm-color-bg-3)}#wallet-placeholder-dash{stroke:var(--wcm-color-overlay)}`
var pa = Object.defineProperty,
  wa = Object.getOwnPropertyDescriptor,
  va = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? wa(t, r) : t, i = e.length - 1, s; i >= 0; i--)
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o)
...
;(tr.styles = [O.globalCss, fa]), (tr = va([k("wcm-view-all-wallets-button")], tr))
const ba = I`.wcm-qr-container{width:100%;display:flex;justify-content:center;align-items:center;aspect-ratio:1/1}`
...
;(er.styles = [O.globalCss]), (er = Ea([k("wcm-connect-wallet-view")], er))
const Aa = I`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`
...
;(se.styles = [O.globalCss, Aa]),
  eo([H()], se.prototype, "isError", 2),
  (se = eo([k("wcm-desktop-connecting-view")], se))
const ka = I`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}wcm-button{margin-top:15px}`
var Ia = Object.defineProperty,
  Ta = Object.getOwnPropertyDescriptor,
  Pa = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? Ta(t, r) : t, i = e.length - 1, s; i >= 0; i--)
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o)
...
let ae = class extends A {
  ...
  render() {
    const { name: e, id: t, image_id: r, app: n, mobile: o } = C.getWalletRouterData(),
      { isWeb: i } = x.getCachedRouterWalletPlatforms(),
      s = n == null ? void 0 : n.ios,
      a = o == null ? void 0 : o.universal
...
;(ae.styles = [O.globalCss, Ma]),
  ro([H()], ae.prototype, "isError", 2),
  (ae = ro([k("wcm-mobile-connecting-view")], ae))
const La = I`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`
...
;(or.styles = [O.globalCss, La]), (or = Da([k("wcm-mobile-qr-connecting-view")], or))
var Ua = Object.defineProperty,
  ja = Object.getOwnPropertyDescriptor,
  Wa = (e, t, r, n) => {
    for (var o = n > 1 ? void 0 : n ? ja(t, r) : t, i = e.length - 1, s; i >= 0; i--)
      (s = e[i]) && (o = (n ? s(t, r, o) : s(o)) || o)
...
;(nr.styles = [O.globalCss]), (nr = Wa([k("wcm-qrcode-view")], nr))
const Ha = I`wcm-modal-content{height:clamp(200px,60vh,600px);display:block;overflow:scroll;scrollbar-width:none;position:relative;margin-top:1px}.wcm-grid{display:grid;grid-template-columns:repeat(4,80px);justify-content:space-between;margin:-15px -10px;padding-top:20px}wcm-modal-content::after,wcm-modal-content::before{content:'';position:fixed;pointer-events:none;z-index:1;width:100%;height:20px;opacity:1}wcm-modal-content::before{box-shadow:0 -1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(var(--wcm-color-bg-1),rgba(255,255,255,0))}wcm-modal-content::after{box-shadow:0 1px 0 0 var(--wcm-color-bg-1);background:linear-gradient(rgba(255,255,255,0),var(--wcm-color-bg-1));top:calc(100% - 20px)}wcm-modal-content::-webkit-scrollbar{display:none}.wcm-placeholder-block{display:flex;justify-content:center;align-items:center;height:100px;overflow:hidden}.wcm-empty,.wcm-loading{display:flex}.wcm-loading .wcm-placeholder-block{height:100%}.wcm-end-reached .wcm-placeholder-block{height:0;opacity:0}.wcm-empty .wcm-placeholder-block{opacity:1;height:100%}wcm-wallet-button{margin:calc((100% - 60px)/ 3) 0}`
...
let ht = class extends A {
  constructor() {
    super(...arguments),
      ...
      (this.searchDebounce = x.debounce((e) => {
        e.length >= 1
          ? ((this.firstFetch = !0), (this.endReached = !1), (this.search = e), W.resetSearch(), this.fetchWallets())
          : this.search && ((this.search = ""), (this.endReached = this.isLastPage()), W.resetSearch())
      }))
  }
  firstUpdated() {
  ...
  async fetchWallets() {
    var e
    const { wallets: t, search: r } = W.state,
      { listings: n, total: o, page: i } = this.search ? r : t
    if (!this.endReached && (this.firstFetch || (o > ir && n.length < o)))
      try {
        this.loading = !0
        const s = (e = K.state.chains) == null ? void 0 : e.join(","),
          { listings: a } = await W.getWallets({
        ...
        await Promise.all([...l.map(async (c) => x.preloadImage(c)), C.wait(300)]),
...
;(ht.styles = [O.globalCss, Ha]),
  Wt([H()], ht.prototype, "loading", 2),
  Wt([H()], ht.prototype, "firstFetch", 2),
  Wt([H()], ht.prototype, "search", 2),
  Wt([H()], ht.prototype, "endReached", 2),
  (ht = Wt([k("wcm-wallet-explorer-view")], ht))
const Za = I`wcm-info-footer{flex-direction:column;align-items:center;display:flex;width:100%;padding:5px 0}wcm-text{text-align:center}`
...
;(le.styles = [O.globalCss, Za]), oo([H()], le.prototype, "isError", 2), (le = oo([k("wcm-web-connecting-view")], le))
